...
{PPP-алгоритм, геодезические сети, высокоточное позиционирование, ГНСС, передача координат, точность определения, эфемериды, РРР, тропосферная задержка, ионосферная задержка, Российская Федерация,
