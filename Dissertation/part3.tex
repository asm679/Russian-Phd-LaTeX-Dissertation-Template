...
Следующим этапом уравнивания является создание матрицы $A$, отвечающей за геометрию сети. В главных диагоналях матрицы могут быть $-1; 0; 1$. 
\begin{description}
	\item[$-1$] в том случае, если пункт находится в начале определяемого вектора;
	\item[$ 0$] если пункты сети не входят в состав вектора;
	\item[$ 1$] если в конце вектора.
\end{description} 
В таблице 30 приводится исходная матрица $A$.
\begin{equation}
	A =
	\left(\begin{array}{cccccc}
		& LOBN(1) & RUZA(2) & DMTR(3) & MSK2(4) & ZHDR(5)\\ \hline
		LOBN-RUZA & \overbrace{\left\{ \begin{array}{rrr}
				-1 & 0 & 0\\
				0 & -1 & 0\\
				0 & 0 & -1
			\end{array}\right.} & \overbrace{\begin{array}{ccc}
				1 & 0 & 0\\
				0 & 1 & 0\\
				0 & 0 & 1
		\end{array}} & \overbrace{\begin{array}{rrr}
				0 & 0 & 0\\
				0 & 0 & 0\\
				0 & 0 & 0
		\end{array}} & \overbrace{\begin{array}{rrr}
		...
		\end{array}} & \overbrace{\begin{array}{rrr}
				...
				0 & 0 & 0
		\end{array}}\\  \hline
		DMTR-LOBN & \left\{ \begin{array}{rrr}
			1 & 0 & 0\\
			0 & 1 & 0\\
			0 & 0 & 1
		...
		\end{array} & \begin{array}{rrr}
			...
			0 & 0 & 0
		\end{array}\\
		DMTR-ZHDR & \left\{ \begin{array}{rrr}
			0 & 0 & 0\\
			0 & 0 & 0\\
			0 & 0 & 0
		\end{array}\right. & \begin{array}{rrr}
		...
		\end{array} & \begin{array}{rrr}
			...
			0 & 0 & -1
		\end{array}\\
		MSK2-ZHDR & \left\{ \begin{array}{rrr}
			0 & 0 & 0\\
			0 & 0 & 0\\
			0 & 0 & 0
		\end{array}\right. & \begin{array}{rrr}
		...
		\end{array} & \begin{array}{rrr}
			...
			0 & 0 & 1
		\end{array}\\
		LOBN-ZHDR & \left\{ \begin{array}{rrr}
			-1 & 0 & 0\\
			0 & -1 & 0\\
			0 & 0 & -1
		\end{array}\right. & \begin{array}{rrr}
		...
		\end{array} & \begin{array}{rrr}
			...
			0 & 0 & 1
		\end{array}\\
		ZHDR-RUZA & \left\{ \begin{array}{rrr}
			0 & 0 & 0\\
			0 & 0 & 0\\
			0 & 0 & 0
		\end{array}\right. & \begin{array}{rrr}
		...
		\end{array} & \begin{array}{rrr}
			...
			0 & 0 & -1
		\end{array}\\
		RUZA-MSK2 & \left\{ \begin{array}{rrr}
			0 & 0 & 0\\
			0 & 0 & 0\\
			0 & 0 & 0
		\end{array}\right. & \begin{array}{rrr}
		...
		\end{array} & \begin{array}{rrr}
			...
			0 & 0 & 0
		\end{array}\\
		RUZA-DMTR & \left\{ \begin{array}{rrr}
			0 & 0 & 0\\
			0 & 0 & 0\\
			0 & 0 & 0
		\end{array}\right. & \begin{array}{rrr}
		...
		\end{array} & \begin{array}{rrr}
			...
			0 & 0 & 0
		\end{array}\\
		DMTR-MSK2 & \left\{ \begin{array}{rrr}
			0 & 0 & 0\\
			0 & 0 & 0\\
			0 & 0 & 0
		\end{array}\right. & \begin{array}{rrr}
		...
		\end{array} & \begin{array}{rrr}
			...
			0 & 0 & 0
		\end{array}\\
		LOBN-MSK2 & \left\{ \begin{array}{rrr}
			-1 & 0 & 0\\
			0 & -1 & 0\\
			0 & 0 & -1
		\end{array}\right. & \begin{array}{rrr}
...
A=\begin{array}{c}
	...
	\left[\begin{array}{rrrrr}
		-E_{3} & E_{3} & Z_{3} & Z_{3} & Z_{3}\\
		E_{3} & Z_{3} & -E_{3} & Z_{3} & Z_{3}\\
		Z_{3} & Z_{3} & E_{3} & Z_{3} & -E_{3}\\
		Z_{3} & Z_{3} & Z_{3} & -E_{3} & E_{3}\\
		-E_{3} & Z_{3} & Z_{3} & Z_{3} & E_{3}\\
		Z_{3} & E_{3} & Z_{3} & Z_{3} & -E_{3}\\
		Z_{3} & -E_{3} & Z_{3} & E_{3} & Z_{3}\\
		Z_{3} & -E_{3} & E_{3} & Z_{3} & Z_{3}\\
		Z_{3} & Z_{3} & -E_{3} & E_{3} & Z_{3}\\
		-E_{3} & Z_{3} & Z_{3} & E_{3} & Z_{3}
