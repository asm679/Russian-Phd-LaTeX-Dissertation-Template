...
состоит из из~введения, 4 разделов, 
%\ref*{disTotPages}
%\formbytotal{dis_totalchapter}{глав}{ы}{}{},
...
факторов, влияющих на точность передачи координат с использованием спутниковых методов. Помимо этого, приводится классификация РРР-методов обработки спутниковых данных.

\input{Dissertation/part1}

\medskip
% Глава 2
Во \textbf{втором разделе} диссертационной работы рассмотрены современные методы обработки спутниковых измерений по РРР-алгоритму. 
\input{Dissertation/part2}

\medskip
%Глава3
\underline{\textbf{Третий раздел}} посвящен разработке методики создания геодезических сетей при использовании РРР-алгоритма обработки спутниковых данных.
