...
факторов, влияющих на точность передачи координат с использованием спутниковых методов. Помимо этого, приводится классификация PPP-способов обработки спутниковых данных.
